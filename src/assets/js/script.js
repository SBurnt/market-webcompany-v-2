...
$('.main-banner').slick({
  arrows: true,
  dots: true,
  prevArrow: '<div class="prev-slide"><svg width="8" height="10" viewBox="0 0 8 10" xmlns="http://www.w3.org/2000/svg"><path d="M7.0835 8.75L3.25016 5L7.0835 1.16667L5.91683 0L0.91683 5L5.91683 10L7.0835 8.75Z" /></svg></div>',
  nextArrow: '<div class="next-slide"><svg width="8" height="10" viewBox="0 0 8 10" xmlns="http://www.w3.org/2000/svg"><path d="M0.916504 8.75L4.74984 5L0.916504 1.16667L2.08317 0L7.08317 5L2.08317 10L0.916504 8.75Z" /></svg></div>',
